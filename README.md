...
Ollama serving Llama 3.2 and Mistral 7B locally on Ubuntu Server. Python layer with an `OllamaClient` wrapper, CLI tool, and FastAPI REST API. Containerised with Docker Compose, deployed over SSH.

**Raspberry Pi Telescope Guidance System**  
Python and Swift project for automated celestial object guidance. iOS prototype in progress, Bluetooth motor control planned.
